...
<head>
  ...
  <!--end::Base Path -->
  <meta charset="utf-8" />
  <title>PEP BANDUNG | Biodata Orang Tua</title>
          ...
          <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
              <div class="kt-portlet__head-wrapper">
                <a href="/orangtua" class="btn btn-clean btn-icon-sm">
          ...
          <div class="kt-portlet__body" >
            <div class="container">
              <div class="row" style="float: right;">
                    <img alt="icon" src="./assets/media/users/100_7.jpg" width="200px" />
                </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <p class="text-muted mb-0">: Starla Putri</p>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <p class="text-muted mb-0">: 25 - April - 1999</p>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <p class="text-muted mb-0">: 3536446683838</p>
                </div>
              </div>
            
              <div class="row">
                <div class="col-lg-3 col-md-6">
                  <p class="text-muted mb-0">Pekerjaan</p>
                </div>
                <div class="col-lg-3 col-md-6">
                  <p class="text-muted mb-0">: Ibu Rumah Tangga</p>
                </div>
              </div>
            
              <div class="row">
                <div class="col-lg-3 col-md-6">
                  <p class="text-muted mb-0">Gol. Darah</p>
                </div>
                <div class="col-lg-3 col-md-6">
