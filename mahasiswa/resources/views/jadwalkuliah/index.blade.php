...
<head>
  ...
  <!--end::Base Path -->
  <meta charset="utf-8" />
  <title>PEP BANDUNG | Jadwal Kuliah</title>
  ...
  <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
      <div class="kt-subheader__main" style="justify-content: flex-end;">
        <img alt="icon" src="./assets/media/icons/jadwal.png" width="20px" />
        <h3 class="kt-subheader__title"> Jadwal Kuliah</h3>
            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
              <div class="kt-portlet__head-label">
                <span class="kt-portlet__head-icon">
                  <img alt="icon" src="./assets/media/icons/jadwal.png" width="40px" />
                </span>
            ...
            <div class="portlet light portlet-fit bordered">
              <div class="portlet-body table-scrollable">
                <table class="table table-striped table-hover table-bordered jquery-datatables">
                  ...
                  <tr align="center">
                    <td>Senin</td>
                    <td> Bahasa Indonesia <br> Bahasa Inggris <br> Matematika </td>
                  </tr>
                  <tr align="center">
                    <td>Selasa</td>
                    <td> Bahasa Inggris <br> Bahasa Indonesia</td>
                  </tr>
                  <tr align="center">
                    <td>Rabu</td>
                    <td> Matematika <br> Bahasa Indonesia</td>
                  </tr>
                  <tr align="center">
                    <td>Kamis</td>
                    <td> Bahasa Inggris <br> Matematika</td>
                  </tr>
                  <tr align="center">
                    <td>Jumat</td>
                    <td> Matematika</td>
