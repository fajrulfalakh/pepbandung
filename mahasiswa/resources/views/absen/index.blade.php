  ...
  <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
      <div class="kt-subheader__main" style="justify-content: flex-end;">
        <img alt="icon" src="./assets/media/icons/absen.png" width="20px" />
        <h3 class="kt-subheader__title"> Absen</h3>
            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
              <div class="kt-portlet__head-label">
                <span class="kt-portlet__head-icon">
                  <img alt="icon" src="./assets/media/icons/absen.png" width="40px" />
                </span>
