...
<head>
  ...
  <!--end::Base Path -->
  <meta charset="utf-8" />
  <title>PEP BANDUNG | VisiMisi</title>
  ...
  <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
      <div class="kt-subheader__main" style="justify-content: flex-end;">
        <h3 class="kt-subheader__title"> VisiMisi </h3>
        <span class="kt-subheader__separator kt-hidden"></span>
        <div class="kt-subheader__breadcrumbs">
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addVisiMisi">Tambah Data
          </button>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
              ...
              <table class="table table-striped table-bordered jquery-datatables">
               ...
               <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <span>
                     <a href="/datavisimisi/{{$m->id_visimisi}}/show" title="Show details" class="btn btn-sm btn-clean btn-icon btn-icon-md kt-demo-icon__preview" >
                      <i class="flaticon-visible"></i>
                      
                      <a href="/datavisimisi/{{$m->id_visimisi}}/edit" title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md">              
                        <i class="la la-edit"></i>
                        
                        <a href="/datavisimisi/{{$m->id_visimisi}}/delete" title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md">
      ...
      <!-- Modal -->
      <div class="modal fade" id="addVisiMisi" tabindex="-1" role="dialog" aria-labelledby="addVisiMisiTitle" aria-hidden="true">
       <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
         <div class="modal-header">
          <h5 class="modal-title" id="addVisiMisilableTitle">Tambah Data Visi Misi</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
           <span aria-hidden="true">&times;</span>
         </button>
       </div>
       <div class="modal-body">
        <form action="/datavisimisi/create" method="POST" enctype="multipart/form-data">
         {{csrf_field()}}

         <label for="exampleInputEmail1">Visi</label>
         <input name="namavisi" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Visi" required>


         <label for="exampleInputEmail1">Misi</label>
         <input name="namamisi" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Misi" NULL>
