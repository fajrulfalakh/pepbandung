...
<html lang="en">
    ...
    <![endif]-->
        ...
        <script src="{{ asset('assetss/layouts/layout4/scripts/layout.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('assetss/layouts/layout4/scripts/demo.min.js') }}" type="text/javascript"></script>
