  ...
  <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
      <div class="kt-subheader__main" style="justify-content: flex-end;">
        <h3 class="kt-subheader__title"> Prodi</h3>
        <span class="kt-subheader__separator kt-hidden"></span>
        <div class="kt-subheader__breadcrumbs">
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addProdi">Tambah Data
          </button>
          <!-- <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Active link</span> -->
        </div>
        <div class="kt-portlet__head-toolbar">
          <div class="kt-portlet__head-wrapper">
            <a href="/dataprodi" class="btn btn-clean btn-icon-sm">
              ...
              <table class="table table-striped table-hover table-bordered table-sm jquery-datatables" cellspacing="0" width="100%">
               ...
               <tbody>
                ...
                <tr>
                 ...
                 <td>
                  <span>
                   <a href="/dataprodi/{{$m->id_prodi}}/show" title="Show details" class="btn btn-sm btn-clean btn-icon btn-icon-md kt-demo-icon__preview" >
                    <i class="flaticon-visible"></i>
                    
                    <a href="/dataprodi/{{$m->id_prodi}}/edit" title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md">              
                      <i class="la la-edit"></i>
                      
                      <a href="/dataprodi/{{$m->id_prodi}}/delete" title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md">
    ...
    <div class="modal fade" id="addProdi" tabindex="-1" role="dialog" aria-labelledby="addProdiTitle" aria-hidden="true">
     ...
     <div class="modal-body">
      <form action="/dataprodi/create" method="POST">
       {{csrf_field()}}
       <label for="exampleInputEmail1">Nama prodi</label>
       <input name="namaprodi" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama prodi" required>


       <label for="exampleInputEmail1">Materi</label>
       <input name="materi" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="materi prodi" NULL>
