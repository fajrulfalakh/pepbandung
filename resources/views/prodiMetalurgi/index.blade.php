...
<head>
    ...
    <!--end::Base Path -->
    <meta charset="utf-8" />
    <title>PEP BANDUNG | Prodi Metalurgi</title>
                ...
                <thead>
                                ...
                                @foreach ($prodi as $m)
                                    <tr style="white-space: pre-wrap">
                                        ...
                                        <td>
                                            <span>
                                            <a href="/prodiMetalurgi/{{$m->id_prodiMetalurgi}}/show" title="Show details" class="btn btn-sm btn-clean btn-icon btn-icon-md kt-demo-icon__preview" >
                    <i class="flaticon-visible"></i>
                    
                    <a href="/prodiMetalurgi/{{$m->id_prodiMetalurgi}}/edit" title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md">              
                      <i class="la la-edit"></i>
                      
                      <a href="/prodiMetalurgi/{{$m->id_prodiMetalurgi}}/delete" title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                                ...
                                <div class="modal-dialog modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/prodiMetalurgi/create" method="POST">
                                                {{csrf_field()}}
