...
<head>
  ...
  <!--end::Base Path -->
  <meta charset="utf-8" />
  <title>PEP BANDUNG | Show Pegawai</title>
          ...
          <div class="kt-portlet__body">
            <div class="container">
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <i class="text-primary mb-41"></i>
                  <p class="text-muted mb-0">: <img src="{{url('uploadgambar')}}/{{$pegawai->gambar}}" width="50%"></p>
                </div>
              </div>
            </div>
            <div class="container">
              <div class="row">
                <div class="col-lg-3 col-md-6">
                  <i class="text-primary mb-41"></i>
                  <p class="text-muted mb-0">Kode Pegawai</p>
                </div>
                <div class="col-lg-3 col-md-6">
                  <i class="text-primary mb-41"></i>
                  <p class="text-muted mb-0">: {{ $pegawai->kd_pegawai }}</p>
                </div>
              </div>
            </div>
            <div class="container">
              <div class="row">
                <div class="col-lg-3 col-md-6">
                  <i class="text-primary mb-41"></i>
                  <p class="text-muted mb-0">Nama Pegawai</p>
                </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-3 col-md-6">
                  ...
                  <p class="text-muted mb-0">Alamat Pegawai</p>
                </div>
                <div class="col-lg-3 col-md-6">
                  <i class="text-primary mb-4"></i>
