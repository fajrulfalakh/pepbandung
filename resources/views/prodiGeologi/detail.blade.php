...
<head>
    ...
    <!--end::Base Path -->
    <meta charset="utf-8" />
    <title>PEP BANDUNG | Show Jurusan</title>
                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-wrapper">
                                <a href="/jurusan" class="btn btn-clean btn-icon-sm">
                    ...
                    <div class="kt-portlet__body">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <i class="text-primary mb-41"></i>
                                    <p class="text-muted mb-0">: {{ $jurusan->id_jurusan }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-3 col-md-6">
                                    <i class="text-primary mb-41"></i>
                                    <p class="text-muted mb-0">Kode</p>
                                </div>
                                <div class="col-lg-3 col-md-6">
                                    <i class="text-primary mb-41"></i>
                                    <p class="text-muted mb-0">: {{ $jurusan->kd_jurusan }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="container">
