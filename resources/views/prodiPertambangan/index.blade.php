...
<head>
    ...
    <!--end::Base Path -->
    <meta charset="utf-8" />
    <title>PEP BANDUNG | Prodi Pertambangan</title>
                ...
                <thead>
                                ...
                                @foreach ($prodi as $m)
                                    <tr style="white-space: pre-wrap">
                                        ...
                                        <td>
                                            <span>
                                            <a href="/prodiPertambangan/{{$m->id_prodiPertambangan}}/show" title="Show details" class="btn btn-sm btn-clean btn-icon btn-icon-md kt-demo-icon__preview" >
                    <i class="flaticon-visible"></i>
                    
                    <a href="/prodiPertambangan/{{$m->id_prodiPertambangan}}/edit" title="Edit details" class="btn btn-sm btn-clean btn-icon btn-icon-md">              
                      <i class="la la-edit"></i>
                      
                      <a href="/prodiPertambangan/{{$m->id_prodiPertambangan}}/delete" title="Delete" class="btn btn-sm btn-clean btn-icon btn-icon-md">
                      </span>
                                        </td>
                                    </tr>
                                        $i++;
                                ...
                                <div class="modal-dialog modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/prodiPertambangan/create" method="POST">
                                                {{csrf_field()}}
