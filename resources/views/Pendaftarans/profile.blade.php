                                ...
                                <div class="kt-invoice__wrapper">
                                                ...
                                                <div class="kt-portlet__body">
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->email_mhs }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->tempat_lahir }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->tanggal_lahir }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->gender }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">Agama</p>
                                                            </div>
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->agama }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">No Induk Kependudukan</p>
                                                            </div>
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->no_induk_kependudukan }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">Kewarganegaraan</p>
                                                            </div>
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->kewarganegaraan }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">Jenis Tinggal</p>
                                                            </div>
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->jenis_tinggal }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">Transportasi</p>
                                                            </div>
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->alat_transportasi }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->nomor_telepon }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">Nomor Hp</p>
                                                            </div>
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->nomor_hp }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">KPS</p>
                                                            </div>
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->kps }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">Nomor KPS</p>
                                                            </div>
                                                            <div class="col-lg-3 col-md-1">
                                                                <i class="text-primary mb-41"></i>
                                                                <p class="text-muted mb-0">: {{ $pendaftaran->nomor_kps }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="kt-invoice__footer">
                                        <div class="kt-invoice__table  kt-invoice__table--centered table-responsive">
                                            ...
                                            <div class="col-md-2">
                                            <a href="/pendaftaran/{{$pendaftaran->id_pendaftaran_mhs}}/edit" class="btn btn-warning flaticon-edit">edit</a>
                                            </div>
                                            <br>
                                        </div>
                                    </div>
